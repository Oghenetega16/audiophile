                ...
                <div className="bg-white rounded-lg p-8 md:p-12 max-w-[540px] w-full my-auto">
                    ...
                    {orderNumber && (
                        <div className="bg-[#F1F1F1] rounded-lg p-4 mb-4">
                            <p className="text-black/50 text-[13px] mb-1">Order Number:</p>
                            <p className="text-[#D87D4A] font-bold text-[15px]">{orderNumber}</p>
                        </div>
                    )}

                    {/* Subtitle */}
                    <p className="text-black/50 mb-6 text-[15px] leading-[25px]">You will receive an email confirmation shortly.</p>
                    ...
                    <div className="rounded-lg overflow-hidden mb-6 md:mb-8 grid md:grid-cols-[1fr_auto]">
                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-black/50 text-[14px] font-bold leading-[25px]">{formatPrice(items[0].product.price)}</p>
                                        </div>
                                        <p className="text-black/50 text-[15px] font-bold">x{items[0].quantity}</p>
                                    </div>
                        ...
                        <div className="bg-black text-white p-6 flex flex-col justify-center md:min-w-[198px]">
                            <p className="text-white/50 uppercase text-[15px] mb-2 font-medium tracking-wider">Grand Total</p>
                            <p className="text-[18px] font-bold">{formatPrice(grandTotal)}</p>
                        </div>
                    </div>
